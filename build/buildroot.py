...
class BuildrootBuildManager:
    ...
    def write_buildroot_hook_script_libopenssl(
        ...
        # Save the clean Buildroot file once.
        if not backup_path.exists():
            shutil.copy2(libopenssl_mk, backup_path)
            print(f"Created baseline backup: {backup_path}")

        # Every iteration starts from exactly the same baseline.
        ...
        for macro, raw_value in sorted(
            ...
            # Defining OPENSSL_NO_X means feature X must be disabled.
        ...
        # Find the last argument of the existing Configure command.
        ...
        # The previous final argument is no longer final.
        configure_lines[command_end_index] = (
