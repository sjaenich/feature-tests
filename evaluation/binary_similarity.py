...
class BinarySimilarityCalculator:
    ...
    def calculate(
        ...
        # Some versions of the shell script incorrectly return an error after
        # BinDiff successfully prints a result. Accept a parsed result anyway.
    ...
    def _parse_result(
        ...
        # Use the last occurrence in case the script prints the value twice.
        match = matches[-1]
